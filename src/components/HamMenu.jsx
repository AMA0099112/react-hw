    ...
    return (
        ...
        >
            <span className="w-8 h-6 flex flex-col justify-between hover:cursor-pointer">
                {/* 第一條線 */}
                <span
                    className={`bg-accent h-[3px] transition-all duration-400 w-full origin-center ${isOpen
                        ? "opacity-0"
                ...
                {/* 第二條線 */}
                <span
                    className={`bg-accent h-[3px] w-full transition-all duration-400 origin-center ${isOpen
